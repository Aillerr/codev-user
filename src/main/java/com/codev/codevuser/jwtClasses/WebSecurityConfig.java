package com.codev.codevuser.jwtClasses;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                .authorizeRequests().antMatchers("/authentification/login", "/authentification/register").permitAll()
        ...
        //httpSecurity.exceptionHandling().accessDeniedPage("/authentification/login");
    }

    @Override
    public void configure(WebSecurity web) {
        web.ignoring().antMatchers("/authentification/login", "/authentification/register")
